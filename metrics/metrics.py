...
def fairness_score(explainer):
    return float(0.25 * explainer.metric.consistency() + 0.25 * explainer.metric.disparate_impact() + \
                 0.25 * explainer.metric.mean_difference() + 0.25 * explainer.metric.statistical_parity_difference())
